...
/**
 * Servlet implementation class ForgotCandidatePasswordServlet
 */
@WebServlet("/ForgotCandidatePasswordServlet")
public class ForgotCandidatePasswordServlet extends HttpServlet {
     ...
     */
    public ForgotCandidatePasswordServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String page = "candidateReset.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			PreparedStatement statement = DBconnection
					.prepareStatement(QueryUtil.queryByID(CommonConstants.QUERY_ID_UPDATE_PASSWORD_CANDIDATE));
			...
			default:
				...
				RequestDispatcher dispatcher1 = getServletContext().getRequestDispatcher("/candidateLogin.jsp");
