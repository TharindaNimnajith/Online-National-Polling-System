	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			PreparedStatement statement = DBconnection.
					prepareStatement(QueryUtil.queryByID(CommonConstants.QUERY_ID_SELECT_VOTER));
		...
		if(returnValue) {
			...
			try {
				PreparedStatement statement = DBconnection.
						prepareStatement(QueryUtil.queryByID(CommonConstants.QUERY_ID_SELECT_VOTER_ID));
				...
				PreparedStatement statement1 = DBconnection.
						prepareStatement(QueryUtil.queryByID(CommonConstants.QUERY_ID_SELECT_TYPE_VOTER));
