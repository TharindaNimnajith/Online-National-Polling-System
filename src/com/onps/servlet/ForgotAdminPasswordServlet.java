...
/**
 * Servlet implementation class ForgotAdminPasswordServlet
 */
...
public class ForgotAdminPasswordServlet extends HttpServlet {
     ...
     */
    public ForgotAdminPasswordServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/** Initialize logger */
		final Logger log = Logger.getLogger(AdminServiceImpl.class.getName());
		...
		try {
			PreparedStatement statement = DBconnection
					.prepareStatement(QueryUtil.queryByID(CommonConstants.QUERY_ID_UPDATE_PASSWORD_ADMIN));
			...
			default:
				...
				RequestDispatcher dispatcher1 = getServletContext().getRequestDispatcher("/adminLogin.jsp");
