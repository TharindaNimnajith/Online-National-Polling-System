	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			PreparedStatement statement = DBconnection.
					prepareStatement(QueryUtil.queryByID(CommonConstants.QUERY_ID_SELECT_ADMIN));
		...
		if(returnValue) {
			...
			try {
				PreparedStatement statement = DBconnection.
						prepareStatement(QueryUtil.queryByID(CommonConstants.QUERY_ID_SELECT_ADMIN_ID));
				...
				PreparedStatement statement1 = DBconnection.
						prepareStatement(QueryUtil.queryByID(CommonConstants.QUERY_ID_SELECT_TYPE_ADMIN));
