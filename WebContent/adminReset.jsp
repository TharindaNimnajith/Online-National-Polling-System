...
<html>
	<head>
		...
		<title>Admin Password Reset || Online National Polling System</title>
	</head>
	...
	<body>	
		...
		<center><h1>Reset Your Password - Admin</h1></center>
		
		<form method="post" name="form" onsubmit="return validateEmail();" action="ForgotAdminPasswordServlet">
