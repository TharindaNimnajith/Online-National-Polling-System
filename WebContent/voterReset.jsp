...
<html>
	<head>
		...
		<title>Voter Password Reset || Online National Polling System</title>
	</head>
	...
	<body>	
		...
		<center><h1>Reset Your Password - Voter</h1></center>
		
		<form method="post" name="form" onsubmit="return validateEmail();" action="ForgotVoterPasswordServlet">
