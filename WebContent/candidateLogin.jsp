<!--
 * This is the candidate login page
-->
...
<html>
	<head>
		...
		<title>Candidate Login || Online National Polling System</title>
	</head>
	...
	<body>
		...
		<center><h1>Candidate Login</h1></center>	
		
		<div class="wrapper fadeInDown">
  			<div id="formContent">
				<form name="form" method="post" onsubmit="return validateLogin(this);" action="CandidateLoginServlet">	
					<div>
						<br />
				...
				<div id="formFooter">
					<label>Forgot password? Click <a href="candidateReset.jsp">here</a> to reset password</label>
					<label>Don't have an account? Click <a href="candidateRegistration.jsp">here</a> to register</label>
				</div>
		  	</div>
		</div>
