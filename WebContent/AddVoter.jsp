...
<html>
	<head>
		...
		<title>Add Voter || Online National Polling System</title>
	</head>
	...
	<body>
		...
		<center><h1>Add Voters</h1></center>
		
		<div class="wrapper fadeInDown">
  			<div id="formContent">
				<form method="post" name="form" onsubmit="return validateAddVoter(this);" action="AddVoterServlet">
					<table>
						<tr>
							<td>Username</td>
		...
		<form method="post" action="ListVoterServlet">
			<div class="list">
				<input type="submit" id="list1" value="List All Voters" />
			</div>
		</form>
