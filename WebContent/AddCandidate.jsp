...
<html>
	<head>
		...
		<title>Add Candidate || Online National Polling System</title>
	</head>
	...
	<body>
		...
		<center><h1>Add Candidates</h1></center>
		
		<div class="wrapper fadeInDown">
  			<div id="formContent">
				<form method="post" name="form" onsubmit="return validateAddVoter(this);" action="AddCandidateServlet">
					<table>
						<tr>
							<td>Username</td>
		...
		<form method="post" action="ListCandidateServlet">
			<div class="list">
				<input type="submit" id="list1" value="List All Candidates" />
			</div>
		</form>
