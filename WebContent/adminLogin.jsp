...
<html>
	<head>
		...
		<title>Admin Login || Online National Polling System</title>
	</head>
	...
	<body>
		...
		<div class="wrapper fadeInDown">
  			<div id="formContent">
				<form name="form" method="post" onsubmit="return validateLogin(this);" action="AdminLoginServlet">	
					<div>
						<br />
				...
				<div id="formFooter">
					<label>Forgot password? Click <a href="adminReset.jsp">here</a> to reset password</label>
				</div>
		  	</div>
		</div>
